...
Route::middleware(['auth'])->group(function () {
    ...
    Route::post('/products/import-asaan-retail', [ProductController::class, 'importAsaanRetail'])->name('products.import.asaanretail')->middleware('check.permission:products.create');
    // ── Purchase helpers ──────────────────────────────────────────────
